...
class Login extends MY_Controller{
    ...
    public function index() {
        ...
        if($_SESSION['login_status'] == 0){
            ...
            redirect($controller_name.$queryString);
        }
    }
    ...
    public function guest_register()
    {
        ...
        if($checkLoginResult){
            ...
            // $_SESSION['user_profile_err_msg'] = $errMsg;
    ...
    public function logout_user(){
        ...
        if(isset($_SESSION['calling_controller_name']) && ($_SESSION['calling_controller_name'] == 'flights') && (isset($_SESSION['currentUrlFlight']))){
            $_SESSION['login_status'] = 0;
            redirect($_SESSION['currentUrlFlight']);
            unset($_SESSION);
        }
        else if(isset($_SESSION['calling_controller_name']) && ($_SESSION['calling_controller_name'] == 'User')) {
            $_SESSION['login_status'] = 0;
            redirect('flights');
        }
        else if(isset($_SESSION['currentUrl'])){
            $_SESSION['login_status'] = 0;
