    ...
    function imagerequired()
    {
        if ( $_FILES AND $_FILES['image']['name'] )
        {
            ...
            else
            {
                ...
                $temp_file_location = './images/store/images/'.$store_id.'/'.$uploadDetails['file_name'];
                $cloudinary_file_location = 'images/store/images/'.$store_id.'/'.$uploadDetails['raw_name'];
                
                if(\Cloudinary\Uploader::upload($uploadDetails['full_path'], 
                                                array('public_id' => $cloudinary_file_location ,
                                                      "use_filename" => TRUE
//                                                        "eager" => array(array("width" => 240, "height" => 320, c_fit),
//                                                                         array("width" => 480, "height" => 800, c_fit),
//                                                                         array("width" => 720, "height" => 1280, c_fit))
                                                                        )))
                {
                ...
                {
                    $this->form_validation->set_message('imageRequired', 'Failed to upload image to Cloudinary. Please try again later!');
                    unlink($temp_file_location);
                    return false;
                }*/
                return true;
