...
class leave extends CI_Controller{
    ...
    function checkleave()
    {
        ...
        else
        {
            ...
            {
                $this->form_validation->set_message('checkleave', 'Leave with selected Activtiy already exists! Please try again with a different Name or Activity.');
                return false;
            }
        }
    }
    ...
    function add()
    {
        ...
        $this->form_validation->set_rules('activity_leave_dates', 'leave_dates', 'required|callback_checkdates');
