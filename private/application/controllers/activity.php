...
//_SESSION['currentUrl'] = current_full_url();
    ...
    public function index() {
        ...
        //print_r('act_index');print_r($_SESSION);die;
        //$_SESSION['currentUrl'] = current_full_url();
        ...
        //session_unset("country_id");

        //$_SESSION['calling_controller_name'] = "activity";
        // $callingViewDetails = array("calling_view_name"=>"home");
        // $this->set_user_session($callingViewDetails);
        //$_SESSION['calling_view_name'] = "home";
        $_SESSION['currentUrl'] = current_full_url();
    ...
    public function get_search_results(){
        $_SESSION['calling_controller_name'] = "activity";
        $_SESSION['currentUrl'] = current_full_url();
        //if($_SESSION['calling_view_name'] !== "login"){
    ...
    public function get_activity() {
        ...
        //print_r($activityLeaveDetails);die;
    ...
    public function create_activity_booking(){
        ...
        $_SESSION['activity_total_fare'] = $bookingAmount;
    ...
    public function update_booking_status() {
        ...
        if($paymentStatus == "Success"){
            ...
            $message = site_url('activity/generate_act_ticket?booking_id='.$act['booking_id']);
            $headers = "From: info@farebucket.com";
            $mail_sent = @mail( $to, $subject, $message, $headers ); 
    ...
    public function cancel_ticket($bookingId) {
        ...
        $message = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head> <meta name="viewport" content="width=device-width"/> <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/> <title>Farebucket</title> <link rel="stylesheet" href="http://www.farebucket.com/css/email.css"></head><body bgcolor="#FFFFFF"> <table class="head-wrap"> <tr> <td></td><td class="header container"> <div class="content"> <table> <tr> <td><img src="http://www.farebucket.com/img/logo.png"/> </td><td align="right"> <h6 class="collapse"></h6> </td></tr></table> </div></td><td></td></tr></table> <hr/> <table class="body-wrap"> <tr> <td></td><td class="container" bgcolor="#FFFFFF"> <div class="content"> <table> <tr> <td> <h3>Hi, '.$name.'</h3> <p class="lead">Your ticket with booking id '.$cancelRequest['hash_val'].' and PNR '.$cancelRequest['tin'].', Has now been cancelled. The refund amount, if any, will be credited back to you in 7-8 working days. Please contact customer support at Phone num: +91-1234567890, Email ID: admin@farebucket.com for any further assistance.</p> <hr/> <table class="social" width="100%"> <tr> <td> <table align="left" class="column"> <tr> <td> <h5 class="">Contact Info:</h5> <p>Phone: <strong>1234567890</strong> <br/>Email: <strong><a href="emailto:hseldon@trantor.com">admin@farebucket.com</a></strong> </p></td></tr></table><span class="clear"></span> </td></tr></table> <hr/> </td></tr></table> </div></td><td></td></tr></table> <table class="footer-wrap"> <tr> <td></td><td class="container"> <div class="content"> <table> <tr> <td>© 2013–2015 Reddytrip LLP.</td></tr></table> </div></td><td></td></tr></table></body></html>';
