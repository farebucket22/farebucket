...
<?php
    $fare = json_decode(stripcslashes($data['fare']));
    $booking_details = json_decode(stripcslashes($data['booking_details']));
    ...
    <?php if( is_array($booking_details) ): 
        ...
        <?php else:?>
            <div class="row center-align-text fl_row">
                ...
                <div class="col-lg-6 left-text">
                    <div class="row date-text center-align-text">Flight Number</div>
                    <div class="row date-text center-align-text"><?php echo $$booking_details->OperatingCarrier;?> - <?php echo $booking_details->Craft;?></div>
                </div>
                        ...
                        <table class="table table-condensed table-custom" >
                            <tbody>
                                ...
                                <tr>
                                    <td></td>
                                    <td class="right-text tf-cng">
                                        <div class="strikeClass"><i class="fa fa-inr"></i>&nbsp;<strike class="oldTotalFare"><?php echo $old_total;?></strike></div>    
                                    </td>
                                </tr>
                                <?php endif; ?>
                                <tr>
                                    <td>Total Fare</td>
                                    <td class="right-text tf-cng"><div class="row totFare"><strike><i class="fa fa-inr"></i>&nbsp;<?php echo $total_fare;?></strike></div><div class="row finalFare"><i class="fa fa-inr"></i>&nbsp;<span><?php echo $total_fare;?></span></div></td>
                                </tr>
