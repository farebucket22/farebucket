...
<?php
    ...
    $fare_obj = $data['inbound_booking_details']->rest->Fare;
    $total_base_fare_inbound = $fare_obj->BaseFare;
    $total_tax_fare_inbound = $fare_obj->AdditionalTxnFee + $fare_obj->AirTransFee + $fare_obj->Tax + $fare_obj->OtherCharges + $fare_obj->ServiceTax;
    $total_fare_inbound = $total_base_fare_inbound+$total_tax_fare_inbound;*/
    ...
    if((isset($_SESSION['hasFareChangedOut'])) && ($_SESSION['hasFareChangedOut'] == 1)){
        ...
        // if(isset($_SESSION['old_total_fare_out']))
        //     $total_fare_outbound = $_SESSION['old_total_fare_out'];
        $fare_obj1 = $data['outbound_booking_details']->rest->Fare;
        $total_base_fare_outbound = $fare_obj1->BaseFare;
        $total_tax_fare_outbound = $fare_obj1->AdditionalTxnFee + $fare_obj1->AirTransFee + $fare_obj1->Tax + $fare_obj1->OtherCharges + $fare_obj1->ServiceTax;
        $total_fare_outbound = $total_base_fare_outbound+$total_tax_fare_outbound;
    ...
    if((isset($_SESSION['hasFareChangedIn'])) && ($_SESSION['hasFareChangedIn'] == 1)){
        $total_base_fare_inbound = $_SESSION['new_base_fare_in'];
        $total_tax_fare_inbound = $_SESSION['new_tax_in'];
        $total_fare_inbound = $_SESSION['new_total_fare_in'];
        $total_fare_inbound_before = $_SESSION['old_total_fare_in'];
    }
    else{
        // if(isset($_SESSION['old_total_fare_in']))
        //     $total_fare_inbound = $_SESSION['old_total_fare_in'];
        $fare_obj = $data['inbound_booking_details']->rest->Fare;
        $total_base_fare_inbound = $fare_obj->BaseFare;
        $total_tax_fare_inbound = $fare_obj->AdditionalTxnFee + $fare_obj->AirTransFee + $fare_obj->Tax + $fare_obj->OtherCharges + $fare_obj->ServiceTax;
        $total_fare_inbound = $total_base_fare_inbound+$total_tax_fare_inbound;
    ...
    <?php if( is_array($data['outbound_booking_details']->rest->Segment->WSSegment) ): 
        ...
        <div class="row center-align-text fl_row">
            ...
            <div class="col-lg-6 left-text">
                ...
                <div class="row date-text"><?php echo $ws->OperatingCarrier;?> - <?php echo $ws->Craft;?></div>
            </div>
        ...
        <?php else:?>
            <div class="row center-align-text fl_row">
                ...
                <div class="col-lg-6 left-text">
                    <div class="row date-text center-align-text">Flight Number</div>
                    <div class="row date-text center-align-text"><?php echo $data['outbound_booking_details']->rest->Segment->WSSegment->OperatingCarrier;?> - <?php echo $data['outbound_booking_details']->rest->Segment->WSSegment->Craft;?></div>
                </div>
...
<!-- popover screen inbound -->
<div class="hidden-fields">
    <div id="popoverHiddenContentIn" style="display: none">
    <?php $max_arr_len = count($data['inbound_booking_details']->rest->Segment->WSSegment); $iter = 0;?>
    <?php if( is_array($data['inbound_booking_details']->rest->Segment->WSSegment) ): 
        foreach($data['inbound_booking_details']->rest->Segment->WSSegment as $ws): ?>
        <?php
            $depTime = date('H:i', strtotime($ws->DepTIme));
            $arrTime = date('H:i', strtotime($ws->ArrTime));
            $depDate = date('d M Y', strtotime($ws->DepTIme));
            $Layover = strtotime($ws->DepTIme);
            $var1 = strtotime($data['inbound_booking_details']->rest->Segment->WSSegment[$iter]->DepTIme);
            $var2 = strtotime($data['inbound_booking_details']->rest->Segment->WSSegment[$iter]->ArrTime);
            $var3 = $var2 - $var1;
            $n = $var3/(60*60);
            $hrs = floor($n);      
            $fraction = $n - $hrs;
        ...
        <?php 
            if( $iter != $max_arr_len - 1 ){
            echo '<div class="row center-align-text">';
                echo '<div class="col-lg-6 remove-padding grey-line"></div>';
                echo '<div class="col-lg-12 remove-padding"> Layover - '.$data['inbound_layover'][$iter].' </div>';
                echo '<div class="col-lg-6 remove-padding grey-line"></div>';
            echo '</div>';}
        ?>
        <?php $iter++; endforeach;?>
        <?php else:?>
            <div class="row center-align-text fl_row">
                ...
                <div class="col-lg-6 left-text">
                    <div class="row date-text center-align-text">Flight Number</div>
                    <div class="row date-text center-align-text"><?php echo $data['inbound_booking_details']->rest->Segment->WSSegment->OperatingCarrier;?> - <?php echo $data['inbound_booking_details']->rest->Segment->WSSegment->Craft;?></div>
                </div>
                <div class="col-lg-12 travel-text-margin remove-padding">
                    <div class="row travel-text">
                        <div class="col-lg-11 remove-padding" id="originPop"><?php echo $data['inbound_booking_details']->rest->Segment->WSSegment->Origin->CityName;?><div class="row center-align-text time_text" id="from"><?php echo $data['inbound_from_field']?></div></div>
                        <span class='col-lg-2 gly-ctm glyphicon glyphicon-play'></span>
                        <div class="col-lg-11 remove-padding" id="destinationPop"><?php echo $data['inbound_booking_details']->rest->Segment->WSSegment->Destination->CityName;?><div class="row center-align-text time_text" id="from"><?php echo $data['inbound_to_field']?></div></div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="row dur-text"><?php echo $data['inbound_flight_duration_field'];?></div>
                    <div class="row date-text center-align-text"><?php echo date('d M Y', strtotime($data['inbound_from_date']));?></div>
                </div>
            </div>
        <?php endif;?>
    </div>

        <div id="popoverHiddenTitleIn" style="display: none">
            <div class="row">
                <div class="col-lg-12 pull-left">
                    <div class="col-lg-4">
                        <?php if( is_array($data['inbound_booking_details']->rest->Segment->WSSegment) ): ?>
                        <?php $ar_logo = $data['inbound_booking_details']->rest->Segment->WSSegment[0]->Airline->AirlineCode;?>
                        <img src="<?php echo base_url('img/AirlineLogo/'.$ar_logo.'.gif');?>" onError="this.src='<?php echo base_url('img/flightIcon.png'); ?>'" alt="jA" width='30px' />
                    </div>
                    <div class="col-lg-offset-2 col-lg-18 pop-title-text"><?php echo $data['inbound_booking_details']->rest->Segment->WSSegment[0]->Airline->AirlineName;?></div>
                    <?php else:?>
                    <?php $ar_logo = $data['inbound_booking_details']->rest->Segment->WSSegment->Airline->AirlineCode;?>
                    <img src="<?php echo base_url('img/AirlineLogo/'.$ar_logo.'.gif');?>" onError="this.src='<?php echo base_url('img/flightIcon.png'); ?>'" alt="jA" width='30px' />
                </div>
                <div class="col-lg-offset-2 col-lg-18 pop-title-text"><?php echo $data['inbound_booking_details']->rest->Segment->WSSegment->Airline->AirlineName;?></div>
                <?php endif;?>
            </div>
            <div class="col-lg-12 pull-right">
                <div class="col-lg-offset-6 col-lg-4 img-cal">
                ...
                <div class="col-lg-12 pop-title-text"><?php echo date('d M Y', strtotime($data['inbound_from_date']));?></div>
            </div>
        </div>
    </div> 
</div>
<!-- popover screen inbound end -->
    ...
    <div class="clear-top">
        ...
        <nav class="navbar fixed-top" style="margin-top:0.5%; box-shadow: 0 1px 2px rgba(0,0,0,.05);">
                ...
                <div class="row fl_overwiew">
                    <div class="col-lg-5 fl_septr1">
                        ...
                        <div class="col-lg-14 fl_info">
                            <div class="row">
                                <div class="col-lg-offset-4 col-lg-18 travel-text">
                                    <div class="row center-align-text">
                                        <div class="col-lg-11 remove-padding srcDest" id="origin1"><?php echo $data['outbound_destination'];?></div>
                                        <span class='col-lg-2 gly-ctm glyphicon glyphicon-play'></span>
                                        <div class="col-lg-11 remove-padding srcDest" id="destination1"><?php echo $data['outbound_source'];?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-23 col-lg-offset-1 center-align-text fare-padding TotFare1"><i class="fa fa-inr"></i>&nbsp;<span><?php echo $data['outbound_total_fare_field'];?></span></div>
                            </div>
                        </div>
                        <div class="col-lg-4 pull-right">
                            <div class="row fl_btn1">
                                <div class="link-btn-de link-btn-de-traveller">
                                    <a href="#" tabindex="0" class='btn-de' id='popover-toggle-outbound' data-toggle="popover" data-placement="bottom">DETAILS</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 fl_septr1">
                        ...
                        <div class="col-lg-14 fl_info">
                            <div class="row">
                                <div class="col-lg-offset-4 col-lg-18 travel-text">
                                    <div class="row center-align-text">
                                        <div class="col-lg-11 remove-padding srcDest" id="origin2"><?php echo $data['inbound_destination'];?></div>
                                        <span class='col-lg-2 gly-ctm glyphicon glyphicon-play'></span>
                                        <div class="col-lg-11 remove-padding srcDest" id="destination2"><?php echo $data['inbound_source'];?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-23 col-lg-offset-1 center-align-text fare-padding TotFare2"><i class="fa fa-inr"></i>&nbsp;<span><?php echo $data['inbound_total_fare_field'];?></span></div>
                            </div>
                        </div>
                        <div class="col-lg-4 pull-right">
                            <div class="row fl_btn1">
                                <div class="link-btn-de link-btn-de-traveller">
                                    <a href="#" tabindex="0" class='btn-de' id='popover-toggle-inbound' data-toggle="popover" data-placement="bottom">DETAILS</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- <div  class="container-fluid" id="info">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="col-lg-12">
                            <div class="center-align-text flight-text">Flight 1</div>
                            <div class="row center-align-text time_text">
                                <?php echo $journey_date['to_date'];?> 
                            </div>
                            <div class="row">
                                <div class="col-lg-offset-4 col-lg-6 remove-padding">
                                    <div class="row">
                                        <div class="srcDest"><?php echo $data['outbound_destination'];?></div>
                                    </div>
                                    <div class="row center-align-text">
                                        <?php echo $data['outbound_from_field'];?>
                                    </div>
                                </div>
                                ...
                                <div class="mgn-right col-lg-6 remove-padding">
                                    <div class="row">
                                        <div class="srcDest"><?php echo $data['outbound_source'];?></div>
                                    </div>
                                    <div class="row center-align-text">
                                        <?php echo $data['outbound_to_field'];?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-24 center-align-text"><?php echo $data['outbound_airline_name_field'];?></div>
                            </div>
                            <div class="row">
                                <div class="col-lg-24 center-align-text TotFare"><?php echo '<i class="fa fa-inr"></i>&nbsp;'.$data['outbound_total_fare_field'];?></div>
                            </div>
                            <div class="row">
                                <div class="col-lg-24 center-align-text time_text"><?php echo $data['outbound_flight_duration_field'];?></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="col-lg-12">
                            <div class="center-align-text flight-text">Flight 2</div>
                            <div class="row center-align-text time_text">
                                <?php echo $journey_date['from_date'];?> 
                            </div>
                            <div class="row">
                                <div class="col-lg-offset-4 col-lg-6 remove-padding">
                                    <div class="row">
                                        <div class="srcDest"><?php echo $data['inbound_destination'];?></div>
                                    </div>
                                    <div class="row center-align-text">
                                        <?php echo $data['inbound_from_field'];?>
                                    </div>
                                </div>
                                <div class="col-lg-4 remove-padding">
                                    <div class="srcDest"><span class="glyphicon glyphicon-play"></span></div>
                                ...
                                <div class="mgn-right col-lg-6 remove-padding">
                                    <div class="row">
                                        <div class="srcDest"><?php echo $data['inbound_source'];?></div>
                                    </div>
                                    <div class="row center-align-text">
                                        <?php echo $data['inbound_to_field'];?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-24 center-align-text"><?php echo $data['inbound_airline_name_field'];?></div>
                            </div>
                            <div class="row">
                                <div class="col-lg-24 center-align-text TotFare"><?php echo '&#8377 '.$data['inbound_total_fare_field'];?></div>
                            </div>
                            <div class="row">
                                <div class="col-lg-24 center-align-text time_text"><?php echo $data['inbound_flight_duration_field'];?></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="col-xs-24 col-sm-14 col-md-18 col-lg-18">
                <form action="<?php echo site_url('api/flights/book_return')?>" method="post" id="travellers-form" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-24 col-sm-24 col-md-24 bookingSelectionDetails">
                        <table class="table table-condensed table-custom" >
                            <tbody>
                                ...
                                <tr>
                                    <td>Outbound Taxes</td>
                                    <td class="right-text tf-cng"><i class="fa fa-inr"></i>&nbsp;<?php echo number_format($total_tax_fare_outbound, 2);?></td>
                                </tr>
                                <tr>
                                    <td>Outbound Base Fare</td>
                                    <td class="right-text tf-cng"><i class="fa fa-inr"></i>&nbsp;<?php echo number_format($total_base_fare_outbound, 2);?></td>
                                </tr>
                                <tr>
                                    <td>Inbound Taxes</td>
                                    <td class="right-text tf-cng"><i class="fa fa-inr"></i>&nbsp;<?php echo number_format($total_tax_fare_inbound, 2);?></td>
                                </tr>
                                <tr>
                                    <td>Inbound Base Fare</td>
                                    <td class="right-text tf-cng"><i class="fa fa-inr"></i>&nbsp;<?php echo number_format($total_base_fare_inbound, 2);?></td>
                                </tr>
                                <tr>
                                ...
                                <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                                <?php if((isset($_SESSION['hasFareChangedOut']) && ($_SESSION['hasFareChangedOut'] == 1)) || ((isset($_SESSION['hasFareChangedIn'])) && ($_SESSION['hasFareChangedIn'] == 1))):?>
                                <tr>
                                    <td></td>
                                    <td class="right-text tf-cng">
                                        <div class="strikeClass"><i class="fa fa-inr"></i>&nbsp;<strike class="oldTotalFare"><?php echo $total_fare_roundtrip_before;?></strike></div>    
                                    </td>
                                </tr>
                                <?php endif; ?>
                                <tr>
...
//discount section
    ...
    var discountClick = 0;
    var total_fare = parseInt("<?php echo $total_fare_roundtrip;?>");
