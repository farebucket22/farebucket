<?php 
// unset($_SESSION['details']['dp_dates']);die;
...
<div class="search-wrapper container">
        ...
        <div class="tab-content change-height">
            ...
            <div class="tab-pane pane-height fade" id="roundTrip">
                ...
                <form action="<?php echo site_url('flights/return');?>" method="get" id="form-submit-2" enctype="multipart/form-data">
                    <div class="form-padding row">
                        <div class="form-group">
                            <div class="col-lg-6 control-label">
                    ...
                    <!--this section adds a new flight destination into the form-->
                        <div class="clone">
                            <div class="row form-padding" id="flight_form_2">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6 col-padding control-label">
                                        <input type="text" onClick="this.select();" class="form-control searchBox" data-num="9" name="city_from_three"
                                        placeholder="From" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-6 col-padding control-label">
                                        <input type="text" onClick="this.select();" class="form-control searchBox" data-num="10" name="city_to_three"
                                        placeholder="To">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="clone">
                            <div class="row form-padding" id="flight_form_3">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6 col-padding control-label">
                                        <input type="text" onClick="this.select();" class="form-control searchBox" data-num="11" name="city_from_four"
                                        placeholder="From" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-6 col-padding control-label">
                                        <input type="text" onClick="this.select();" class="form-control searchBox" data-num="12" name="city_to_four"
                                        placeholder="To">
                                    </div>
                                </div>
                                <div class="form-group">
...
//set input values
        ...
        if( fl_type === "oneway" ){
            ...
            $('#roundTrip input[name=to_date]').val(default_param[0].oneway_date);
            ...
            // $('#multiCity input[name=multi_date_one]').val(default_param[0].dates[0]);
            // $('#multiCity input[name=multi_date_two]').val(default_param[0].dates[1]);
            // $('#multiCity input[name=multi_date_three]').val(default_param[0].dates[2]);
            // $('#multiCity input[name=multi_date_four]').val(default_param[0].dates[3]);
            <?php endif;?>
        }
//set input values end
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url();?>scripts/airport-codes.xml", // change to full path of file on server
            dataType: "xml",
...
// validation part end
    ...
    $('#accordion1').on('click', function(){
        ...
        // panel_width = panel_width - $(this).width()/26;
