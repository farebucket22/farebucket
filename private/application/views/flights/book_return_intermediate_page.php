...
<script>
	$(document).ready(function(){
		...
		var set_outbound_parameters = 
		{
			...
			adult_travellers_titles: "<?php if($data['details']->adult_count_field > 1){echo $data[0]['adult_title_csv'];}else{echo '';};?>",
			adult_travellers_first_names: "<?php if($data['details']->adult_count_field > 1){echo $data[0]['adult_first_name_csv'];}else{echo '';};?>",
			adult_travellers_last_names: "<?php if($data['details']->adult_count_field > 1){echo $data[0]['adult_last_name_csv'];}else{echo '';};?>",
			child_travellers_titles: "<?php if($data['details']->youth_count_field){echo $data[0]['kid_title_csv'];}else{echo '';};?>",
			child_travellers_first_names: "<?php if($data['details']->youth_count_field){echo $data[0]['kid_first_name_csv'];}else{echo '';};?>",
			child_travellers_last_names: "<?php if($data['details']->youth_count_field){echo $data[0]['kid_last_name_csv'];}else{echo '';};?>",
			child_travellers_dobs: "<?php if($data['details']->youth_count_field){echo $data[0]['kid_dob_csv'];}else{echo '';};?>",
			infant_travellers_titles: "<?php if($data['details']->kids_count_field){echo $data[0]['infant_title_csv'];}else{echo '';};?>",
			infant_travellers_first_names: "<?php if($data['details']->kids_count_field){echo $data[0]['infant_first_name_csv'];}else{echo '';};?>",
			infant_travellers_last_names: "<?php if($data['details']->kids_count_field){echo $data[0]['infant_last_name_csv'];}else{echo '';};?>",
			infant_travellers_dobs:"<?php if($data['details']->kids_count_field){echo $data[0]['infant_dob_csv'];}else{echo '';};?>",
			user_id: "<?php if( isset($_SESSION['user_details']) ){echo $_SESSION['user_details'][0]->user_id;}else{echo $_SESSION['guest_id'];}?>",
			...
			hash_val: "<?php echo $data['details']->hash_val;?>",
		...
		var set_inbound_parameters = 
		{
			...
			lead_traveller_email: "<?php echo $data['lead_adult_email_id'];?>", 
			lead_traveller_mobile: "<?php echo $data['lead_adult_mobile_no'];?>",
			adult_travellers_titles: "<?php if($data['details']->adult_count_field > 1){echo $data[1]['adult_title_csv'];}else{echo '';};?>",
			adult_travellers_first_names: "<?php if($data['details']->adult_count_field > 1){echo $data[1]['adult_first_name_csv'];}else{echo '';};?>",
			adult_travellers_last_names: "<?php if($data['details']->adult_count_field > 1){echo $data[1]['adult_last_name_csv'];}else{echo '';};?>",
			child_travellers_titles: "<?php if($data['details']->youth_count_field){echo $data[1]['kid_title_csv'];}else{echo '';};?>",
			child_travellers_first_names: "<?php if($data['details']->youth_count_field){echo $data[1]['kid_first_name_csv'];}else{echo '';};?>",
			child_travellers_last_names: "<?php if($data['details']->youth_count_field){echo $data[1]['kid_last_name_csv'];}else{echo '';};?>",
			child_travellers_dobs: "<?php if($data['details']->youth_count_field){echo $data[1]['kid_dob_csv'];}else{echo '';};?>",
			infant_travellers_titles: "<?php if($data['details']->kids_count_field){echo $data[1]['infant_title_csv'];}else{echo '';};?>",
			infant_travellers_first_names: "<?php if($data['details']->kids_count_field){echo $data[1]['infant_first_name_csv'];}else{echo '';};?>",
			infant_travellers_last_names: "<?php if($data['details']->kids_count_field){echo $data[1]['infant_last_name_csv'];}else{echo '';};?>",
			infant_travellers_dobs:"<?php if($data['details']->kids_count_field){echo $data[1]['infant_dob_csv'];}else{echo '';};?>",
			user_id: "<?php if( isset($_SESSION['user_details']) ){echo $_SESSION['user_details'][0]->user_id;}else{echo $_SESSION['guest_id'];}?>",
			num_of_adults: "<?php echo $data['details']->adult_count_field;?>", 
			num_of_children: "<?php echo $data['details']->youth_count_field;?>", 
			num_of_infants: "<?php echo $data['details']->kids_count_field;?>",
