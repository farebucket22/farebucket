...
<!--                                 <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapseLocation">
                                                Location
                                            </a>
                                        </h4>
                                    </div>
                    ...
                    $('#room_selected').selectOrDie({
                        ...
                        onChange: function(){
                            ...
                            $.ajax({
                                ...
                                data: { room_type : room_type, hotel_info : hotel_info, single_rooms : single_rooms, trace_id : trace_id, priceDetails: resultdata.GetHotelRoomResult.HotelRoomsDetails}
                            })
                            .done(function( msg ) {
