...
<?php 
    ...
    {		
	    ...
	    $hotel_price[$i] = $hotel_info[$i]->Price->PublishedPrice;
	    $hotel_name[] = $hotel_info[$i]->HotelName;
	    $hotel_stars[$i] = $hotel_info[$i]->StarRating.' stars';
	    $total_rooms[$i] = $data[0]['multi_rooms'];
	    $hotel_tax[$i] = $hotel_info[$i]->Price->Tax;
	    $hotel_discount[$i] = $hotel_info[$i]->Price->Discount;
	}
    for($j = 0 ; $j<$total_rooms[0];$j++)
    {
        $i = $j+1;
        $adult[$j] = $data[$j]['adult_count_multi-'.$i];
        $child[$j] = $data[$j]['child_count_multi-'.$i];
    }
    $total_price = 0;
    $convenience_charge = 0;
    $total_hotel_fare = array_sum($hotel_price);
    ...
    foreach( $hotel_price as $hp ){
        $convenience_charge += $hp*$fraction;
        $total_price += $hp;
    }
    // $convenience_charge = ($fraction)*$_SESSION['hotel_price_multi'];
    $total_hotel_fare = $convenience_charge + $total_price;
...
<div class="hidden-fields">
    ...
    <div id="popoverHiddenContent-<?php echo $j+1;?>" style="display:none;">
        <div class="row center-align-text fl_row">
            ...
            <div class="col-lg-5">
                <div class="row date-text center-align-text" style="font-size:18px;"> &#x20B9;<span style="font-family:oswald;font-size:18px;"><?php echo $hotel_price[$j];?></span></div>
            </div>
        </div>
    </div>
	<?php endfor;?>
    ...
    <div id="popoverHiddenTitle-<?php echo $j+1;?>" style="display: none">
        <div class="row">
            <div class="col-lg-24">
                <div class="col-lg-4 dest">
                    <?php echo $destination[$j][0];echo ', ';echo $iso[$j][count($iso[$j])-2];?>
                </div>
                <div class="col-lg-10 pop-title-text">Check-In Date : <span class="checkDate"><?php echo date("d M Y",strtotime($checkin_time[$j]));?></span></div>
                <div class="col-lg-10 pop-title-text">Check-Out Date : <span class="checkDate"><?php echo date("d M Y",strtotime($checkout_time[$j]));?></span></div>
            </div>
            <!-- <div class="col-lg-12">
...
<div class="wrap">
    <div class="clear-top">
        <div class="grey-bottom-separator center-align-text">
            ...
            <span class="TravelDate"></span>Check-In: <?php echo date("d-m-Y",strtotime($data[0]['checkin_time']));?>, Check-Out: <?php echo date("d-m-Y",strtotime($data[0]['checkout_time']));?>
        </div>
                ...
                <div class="row fl_overwiew">
                    ...
                    <div class="col-lg-5 fl_septr1">
                        ...
                        <div class="col-lg-14 fl_info">
                            ...
                            <div class="row">
                                <div class="col-lg-20 col-lg-offset-4 center-align-text TotFare1 fare-padding"> &#x20B9;<span><?php echo $hotel_price[$n];?></span></div>
                            </div>
                        </div>
                        <div class="col-lg-4 pull-right">
                            <div class="row fl_btn1">
                                <div class="link-btn-de link-btn-de-traveller">
                                    <a href="#" tabindex="0" class='btn-de' id='popover-toggle-<?php echo $n+1;?>' data-toggle="popover" data-placement="bottom">DETAILS</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-24 col-sm-24 col-md-24 bookingSelectionDetails">
                        <table class="table table-condensed table-custom" >
                            <tbody>
                                ...
                                <tr>
                                    <td>Taxes</td>
                                    <td class="right-text tf-cng">&#x20B9; <?php echo number_format(array_sum($hotel_tax));?></td>
                                </tr>
                                <tr>
                                    <td>Discount</td>
                                    <td class="right-text tf-cng discount-value">&#x20B9; <?php echo number_format(array_sum($hotel_discount));?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Total Fare</td>
                                    <td class="right-text tf-cng"><div class="row totFare"><strike style="display:none;">&#x20B9; <?php echo $total_hotel_fare;?></strike></div><div class="row finalFare">&#x20B9; <span><?php echo $total_hotel_fare;?></span></div></td>
                                </tr>
