...
<body>
    ...
    <div class="container content">
      <h2 style="margin-top:60px;">Edit Category</h2>
      ...
      <form action="<?php echo site_url('admin/category/update?id='.$category->activity_category_id); ?>" method="post" enctype="multipart/form-data">          
          <label class="control-label">Category Name</label>
          <input type="text" class="input-block-level" placeholder="Category Name" name="name" value="<?php echo $category->activity_category_name; ?>">
          <button class="btn btn-info span12" type="submit">Update</button>
          <a href="<?php echo site_url('admin/category'); ?>" class="btn btn-danger span12 upd-cancel">Cancel</a>
      </form>
      </div>
    </div>
</body>
