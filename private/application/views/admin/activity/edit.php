        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8 text3" style="padding-left:2%;">
                     <textarea name="activity_details" value="" class="form-control" id="details" rows="7" placeholder="Details"><?php echo $activity->activity_description; ?></textarea>
                </div>
                <div class="col-md-4"></div>
            </div>
            <div class="col-md-12">
                        ...
                        <div class="form-group form1">
                            <select name="activity_vendor_name" class="form-control" style="width:350px; margin-top:5%;">
                              ...
                              <?php foreach($vendors as $vendor){?>
                                  <option value="<?php echo $vendor->vendor_name; ?>" <?php if($vendor->vendor_name == $activity->activity_vendor_name) echo 'selected'; ?>><?php echo $activity->activity_vendor_name; ?></option>
                              <?php }?>
                             </select>
                        </div>
                    </div>
