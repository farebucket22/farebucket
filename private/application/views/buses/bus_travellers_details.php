...
<?php 
    ...
    for ($i = 0 ; $i < count($data['seat_details']['seats']) ; $i++) { 
        if( $data['seat_details']['seats'][$i]['ladiesSeat'] == 'true' ){
            $seat[$i] = 'isLadiesSeat';
        }
    }
    ...
    $_SESSION["bus_total_Fare"] = $total_bus_fare;
?>
<style>
    .reg_link{
    text-align: right;
                    ...
                    <div class="col-xs-24 col-sm-24 col-md-24 bookingSelectionDetails">
                        <table class="table table-condensed table-custom" >
                            <tbody>
                                ...
                                <tr>
                                    <td>Discount</td>
                                    <td class="right-text tf-cng discount-value">&#x20B9; <?php echo number_format(0);?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Total Fare</td>
                                    <td class="right-text tf-cng"><div class="row totFare"><strike>&#x20B9; <?php echo number_format($total_bus_fare, 2);?></strike></div><div class="row finalFare">&#x20B9; <span><?php echo number_format($total_bus_fare, 2);?></span></div></td>
                                </tr>
...
//discount section
    ...
    total_fare = parseInt(<?php echo $total_bus_fare;?>);
    var discountClick = 0;
