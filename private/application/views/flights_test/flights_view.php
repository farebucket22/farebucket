    ...
    <div class="container-fluid flights-wrapper clear-top">
        ...
        <div class="tab-content change-height">
            <div class="tab-pane pane-height fade in active" id="oneWay">
                ...
                <form action="<?php echo site_url('flights_new/oneway');?>" method="get" id="form-submit-1" enctype="multipart/form-data">
                    <div class="form-padding row">
                        <div class="form-group">
                            <div class="col-lg-6 control-label">
                                <input type="text" onClick="this.select();" class="form-control searchBox" data-num="1" autocomplete="off" name="from" placeholder="From">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 control-label">
                                <input type="text" onClick="this.select();" class="form-control searchBox" data-num="2" autocomplete="off" name="to" placeholder="To">
                            </div>
                        </div>
                        <div class="col-lg-6">
            ...
            <div class="tab-pane pane-height fade" id="roundTrip">
                ...
                <form action="<?php echo site_url('flights_new/return');?>" method="get" id="form-submit-2" enctype="multipart/form-data">
                    <div class="form-padding row">
                        <div class="form-group">
                            <div class="col-lg-6 control-label">
                                <input type="text" onClick="this.select();" class="form-control searchBox" data-num="3" autocomplete="off" name="from" placeholder="From">
                            </div>
                        </div>
                        <div class="col-lg-1 center-align-text">                            
                            <div class="swap" title="Swap From and To fields"></div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 control-label">
                                <input type="text" onClick="this.select();" class="form-control searchBox" data-num="4" autocomplete="off" name="to" placeholder="To">
                            </div>
                        </div>
                        <div class="col-lg-6">
            ...
            <div class="tab-pane pane-height fade" id="multiCity">
                ...
                <form action="<?php echo site_url('flights_new/multi');?>" method="get" id="form-submit-3" enctype="multipart/form-data">
                    <div class="row form-padding">
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-padding control-label">
                                ...
                                <input type="text" onClick="this.select();" class="form-control searchBox" data-num="5" autocomplete="off" name="city_from_one" placeholder="From">
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-padding control-label">
                                ...
                                <input type="text" onClick="this.select();" class="form-control searchBox" data-num="6" autocomplete="off" name="city_to_one" placeholder="To">
                    ...
                    <div class="row form-padding">
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-padding control-label">
                                ...
                                <input type="text" onClick="this.select();" class="form-control searchBox" data-num="7" autocomplete="off" name="city_from_two" placeholder="From">
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-padding control-label">
                                    ...
                                    <input type="text" onClick="this.select();" class="form-control searchBox" data-num="8" autocomplete="off" name="city_to_two" placeholder="To">
    ...
    $('#form-submit-3').bootstrapValidator({
        ...
        fields: {
            ...
            multi_date_one: {
                validators: {
                    notEmpty: {
                        message: 'The First Date is required'
                    },
                    date: {
                        format: 'DD-MM-YYYY',
                        message: 'Please check the Date Format.'
            ...
            multi_date_two: {
                validators: {
                    notEmpty: {
                        message: 'The Second Date is required'
                    },
                    date: {
                        format: 'DD-MM-YYYY',
                        message: 'Please check the Date Format.'
            ...
            multi_date_three: {
                validators: {
                    notEmpty: {
                        message: 'The Third Date is required'
                    },
                    date: {
                        format: 'DD-MM-YYYY',
                        message: 'Please check the Date Format.'
            ...
            multi_date_four: {
                validators: {
                    notEmpty: {
                        message: 'The Fourth Date is required'
                    },
                    date: {
                        format: 'DD-MM-YYYY',
                        message: 'Please check the Date Format.'
