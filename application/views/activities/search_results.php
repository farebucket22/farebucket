		                            ...
		                            <div id="collapseThree" class="panel-collapse collapse in">
		                                <div class="panel-body">
                                            <fieldset>
                                                ...
                                                <?php $j=1; for ($i=2; $i < count($steps) - 1; $i++) { $j=$j+1;?>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" class="filterCheckbox priceFilter" id="priceFilter-<?php echo $j-1;?>" value=".priceRange-<?php echo $j-1;?>"/>
                                                        <?php echo("Rs.".$steps[$i].".00 - Rs.".$steps[$i+1].".00"); $i++;?>
                                                    </label>
                                                </div><?php }?>
                                                <?php
                                                }
                    ...
                    <div class="col-xs-24 col-sm-24 results">
                        ...
                        if($size===0){
                            ...
                            echo '<div class="col-xs-24 col-sm-6 result mix rating-'.$ar->activity_rating_average_value.' category-'.$ar->activity_category_id.'" data-pricesort="'.$ar->activity_onwards_price.'" data-redid="'.$ar->activity_id.'">'
                                    .'<div class="custThumbnailContainer" style="background: url('.$imgPath.') center center no-repeat; background-size:cover;">'
...
var checkboxFilter = {
  ...
  concatenate: function(){
    ...
    $(document).ready(function(){
        ...
        checkboxFilter.init();
		$('.sortBySelect').val('pricesort:asc');
