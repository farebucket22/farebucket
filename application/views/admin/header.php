<?php $url_split = explode("/",$_SERVER['REQUEST_URI']);?>
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            // {
                if(url[3] === 'activity' || url[3] === "vendor" || url[3] === "leave" || url[3] === "category" || url[3] === "city" || url[3] === "country" || url[3] === "sub_activity")
                    $('.activity').addClass('active');
                else if(url[3] === 'flight' && url[4] === "")
                    $('.flight').addClass('active');
                else if(url[3] === 'hotel')
                    $('.hotel').addClass('active'); 
                else if(url[3] === 'cabs')
                    $('.cab').addClass('active');  
                else if(url[4] === 'discount' || url[3] === 'convenience_charge' || url[3] === 'default_page' || url[4] === 'balance' || url[4] === 'list_background')
                    $('.common').addClass('active');  
                else if(url[3] === 'cancellation')   
...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
                <div class="container">
                  <div class="navbar-header">
                    <a class="navbar-brand logo_image" href="<?php echo site_url('admin/category');?>"><img src="<?php echo base_url(); ?>img/logo.png"></a>
                  </div>
                  <div class="navbar-collapse collapse header_container">
                  <ul class="nav navbar-nav headers">
                      <li class="dropdown user-dropdown activity" >
                       ...
                       <li class="dropdown user-dropdown flight" >
                        <a href="" class="dropdown-toggle" data-toggle="dropdown" style="padding-left: 25px; ">
                            <i class="fa fa-user" ></i>
                            Flight
                            <b class="caret caret_custom"></b>
                    ...
                    <li class="dropdown user-dropdown hotel" >
                        <a href="" class="dropdown-toggle" data-toggle="dropdown" style="padding-left: 25px; ">
                            <i class="fa fa-user" ></i>
                            Hotel
                            <b class="caret caret_custom"></b>
                    ...
                    <li class="dropdown user-dropdown cab" >
                        <a href="" class="dropdown-toggle" data-toggle="dropdown" style="padding-left: 25px; ">
                            <i class="fa fa-user" ></i>
                            Cab
                            <b class="caret caret_custom"></b>
                    ...
                    <li class="dropdown user-dropdown bus" >
                        <a href="" class="dropdown-toggle" data-toggle="dropdown" style="padding-left: 25px; ">
                            <i class="fa fa-user" ></i>
                            Bus
                            <b class="caret caret_custom"></b>
                    ...
                    <li class="dropdown user-dropdown common" >
                        <a href="" class="dropdown-toggle" data-toggle="dropdown" style="padding-left: 12px; ">
                            <i class="fa fa-user" ></i>
                            Common
                            <b class="caret caret_custom"></b>
                        </a>
                    ...
                    <li class="dropdown user-dropdown cancellation" style="width:140px;">
                        <a href="" class="dropdown-toggle" data-toggle="dropdown" style="padding-left: 25px; ">
                            <i class="fa fa-user"></i> Cancellations
                            <b class="caret caret_custom caret-cancel" style="margin-top:-13%;"></b>
                        </a>
                        <ul class="dropdown-menu" style="width:130px; min-width:0;">
                            <li style="text-align: center;">
                      ...
                      <li class="dropdown user-dropdown" style="width:150px;">
                            ...
                            <ul class="dropdown-menu" style="width:135px; min-width:0;">
                                ...
                                <li style=" text-align:center; padding-right:0px;"><a href="<?php echo site_url('admin/login/signout')?>" >
                                        <i class="fa fa-power-off">
