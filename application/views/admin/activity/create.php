    ...
    <form action="<?php echo site_url('admin/activity/add'); ?>" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                  <textarea name="activity_address" class="form-control address" id="address" rows="7" cols="40" placeholder="Activity Address" style="margin-top:18%;"></textarea>
                </div>
                <div class="col-md-4">
                  <div class="form-group form1">
                    <input type="text" name="activity_phone_num" id="activity_phone_num" placeholder="Activity Phone Number" class="form-control activity_phone_num" />
                  </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-8">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form1">
                            <input  name="activity_onwards_price" class="form-control act_no" id="activity_price" placeholder="Activity Price" style="width:350px;">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form1">
