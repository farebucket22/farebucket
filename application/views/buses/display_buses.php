<?php 
    if( isset( $_GET['get_req_active'] ) && $_GET['get_req_active'] == 1 ){
        ...
        if( !isset($_SESSION['ovMode']) && !isset($_SESSION['flight_data'][$count-2])){
            if($count > 1){
...
<form action="<?php echo site_url('bus_api/buses/getTripDetails');?>" method="post" id="book_bus_form" style="display:none;">
...
<div class="wrap">
                                            ...
                                            <div class="col-lg-5 fl_septr1">
                                                ...
                                                <div class="col-lg-14 fl_info">
                                                    <div class="row">
                                                        <div class="col-lg-offset-4 col-lg-18 travel-text">
                                                            <div class="row center-align-text">
                                                                <div class="col-lg-11 remove-padding ellipse" id="origin<?php echo $n+1?>"><?php if(isset($_SESSION['ovMode'])) {echo $_SESSION['ovMode']->org;} else{ echo $_SESSION['flight_data'][$n]['ov']->org; }?></div>
                                                                <span class='col-lg-2 gly-ctm glyphicon glyphicon-play'></span>
                                                                <div class="col-lg-11 remove-padding ellipse" id="destination<?php echo $n+1?>"><?php if(isset($_SESSION['ovMode'])) { echo $_SESSION['ovMode']->dest;} else{ echo $_SESSION['flight_data'][$n]['ov']->dest; }?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <?php else:?>
                                                            <div class="col-lg-23 col-lg-offset-1 center-align-text fare-padding TotFare1">&#x20B9; <span><?php if(isset($_SESSION['ovMode']->total_fare_field)) {echo $_SESSION['ovMode']->total_fare_field;} else{ echo $_SESSION['flight_data'][$n]['ov']->total_fare_field; } ?></span></div>
                                                        <?php endif;?>
                                                    </div>
                                                </div>
    ...
    <div class="container-fluid main clear-top">  
        <div class="row resultsFilters additionalBusResultMargin">
                        ...
                        <div class="row">
                            <div class="panel-group" id="accordion">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapseSeven">
                                                Seat type
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseSeven" class="panel-collapse filterCollapse collapse in">
            ...
            <div class="col-xs-24 col-sm-18 col-sm-offset-cust-3 resultsArea">
                ...
                <?php endif;?>
                <div class="row busResultMarginTop">
                        ...
                        <div class="compare-unit select niceform">
                            <table class="table table-hover-custom select-list smaller bus-table-spacing hide" id="search">
                                ...
                                <?php for( $i = 0 ; $i < count($data['availableTrips']) ; $i++)
                                {
                                    ...
                                    $oneDay=24*60;
                                    $arrivalTime = intval($data['availableTrips'][$i]['arrivalTime']);
                                    if( $arrivalTime != -1 ){
                                        ...
                                        echo '<td class="bus-type-dur">Not Known</td>';
                                    }
                                    if( $arrivalTime != -1 ){
                                        ...
                                        if($minutes < 10)
                                            $minutes = '0'.$minutes;
                                        if( $noOfDays > 0 ){
                                            echo '<td class="bus-type-dur">'. $noOfDays .'d '.$hours.'h '.$minutes.'m </td>';
                                        }else{
...
// navbar modifiedsearch alter end
    ...
    .done(function (flData){
        ...
        if(result !== false)
        {
            ...
            if( typeof result.minFare == 'undefined' ){
                ...
                $('.flightOptionDetailsLine2').html('&#x20B9; ' +result.minFare);
            }
    ...
    function format (row_details_id) {
        ...
        var base_fare_disp = (typeof return_data.availableTrips[index].fareDetails.baseFare === 'undefined') ? return_data.availableTrips[index].fareDetails[1].baseFare : return_data.availableTrips[index].fareDetails.baseFare;
        var service_tax_absolute_disp = (typeof return_data.availableTrips[index].fareDetails.serviceTaxAbsolute === 'undefined') ? return_data.availableTrips[index].fareDetails[1].serviceTaxAbsolute : return_data.availableTrips[index].fareDetails.serviceTaxAbsolute;
        var total_fare_disp = (typeof return_data.availableTrips[index].fareDetails.totalFare === 'undefined') ? return_data.availableTrips[index].fareDetails[1].totalFare : return_data.availableTrips[index].fareDetails.totalFare;
        ...
        for( var i = 0 ; i < can_len ; i++ ){
            ...
            if( i === 0 && can_str[i] === "0:-1:100:0" ){
                ...
                if( info_arr[1] === "-1" ){
                    ...
                    rem_time_convert = rem_time.convertToTime();
                    rem = rem_time_convert.split('0-');
                    if( rem[0] == "" ){
                        rem = rem[1];
                    }
                    else{
                    ...
                    ret_str_can += '<div class="col-lg-20">'+'Till <b>'+rem+'</b> on <b>'+rem_date.getDate()+'-'+month[rem_date.getMonth()]+'-'+rem_date.getFullYear()+'</b></div>';
                }else{
                    ...
                    rem_time_0 = rem_time_0.convertToTime();
                    rem_time_0 = rem_time_0.split('0-');
                    if( rem_time_0[0] == "" ){
                        rem_time_0 = rem_time_0[1];
                    }
                    else{
                        rem_time_0 = rem_time_0[0];
                    }
                    rem_time_1 = rem_time_1.convertToTime();
                    rem_time_1 = rem_time_1.split('0-');
                    if( rem_time_1[0] == "" ){
                        rem_time_1 = rem_time_1[1];
                    }
                    else{
                        rem_time_1 = rem_time_1[0];
                    }
                    if( info_arr[0] === "0" ){
                        ret_str_can += '<div class="col-lg-20">'+'After <b>'+rem_time_0+'</b> on <b>'+rem_date_0.getDate()+'-'+month[rem_date_0.getMonth()]+'-'+rem_date_0.getFullYear()+'</b></div>';
                    }else{
                        ret_str_can += '<div class="col-lg-20">'+'between <b>'+rem_time_0+'</b> on <b>'+rem_date_0.getDate()+'-'+month[rem_date_0.getMonth()]+'-'+rem_date_1.getFullYear()+'</b> - <b>'+ rem_time_1+'</b> on <b>'+rem_date_1.getDate()+'-'+month[rem_date_1.getMonth()]+'-'+rem_date_1.getFullYear()+ '</b></div>';
                    }
                }
                //amount section
