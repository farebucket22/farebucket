...
<body>
	<div class="wrap">
		<div class="container clear-top bus">
			<div class="row">
				...
				<div class="col-lg-12 etckt-container">
					...
					<h4 class="tin">TIN - <span><?php echo $data->pnr;?></span></h4>
			...
			<div class="row">
				...
				<div class="row intin-container">
					...
					<h3 class="act_date">&nbsp;|&nbsp;<?php echo date('l, d M Y', strtotime($data->doj));?>&nbsp;<span class="h3"><?php echo $hours.":".$minutes." Hrs";?></span></h3>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-9">
				...
				<div class="col-lg-10">
					<div class="col-lg-24 col-xs-24 center-align-text journey"><span class="tckt-dep">Journey</span></div>
					<div class="col-lg-12 col-xs-12 center-align-text dept">
						<span class="h5"><b>Departure</b></span>
						<h4><?php echo $source;?></h4>
						<h6 class="remove-margin"><?php echo date('d M Y', strtotime($data->doj));?></h6>
					</div>
					<div class="col-lg-12 col-xs-12 center-align-text arr">
				...
				<div class="col-lg-5">
				<div class="col-lg-24 col-xs-24 center-align-text journey"><span class="tckt-dep">Fare</span></div>
					<?php if(is_array($data->inventoryItems)):?>
						<table class="col-lg-24 col-xs-24">
							<tbody>
			...
			<div class="row passenger-list bus-list">
				<?php if(is_array($data->inventoryItems)):?>
					<?php foreach($data->inventoryItems as $im):?>
						<?php if($im->passenger->primary == 'true'):?>
							...
							<div class="col-lg-4 col-xs-4 passenger-headers">
								<h5><b>No of Occupants</b></h5>
								<p><?php echo $no_pax?></p>
							</div>
							<div class="col-lg-6 col-xs-10 passenger-headers">
								<h5><b>Inventory ID</b></h5>
								<p class="inventory"><?php echo $data->inventoryId;?></p>
							</div>
							<div class="col-lg-6 col-xs-4 passenger-headers">
								<h5><b>Seat Name</b></h5>
			...
			<div class="row">
				<div class="col-lg-14 passenger-headers form-padding baggageInfo busCancel">
