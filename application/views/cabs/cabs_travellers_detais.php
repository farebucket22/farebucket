...
<div class="hidden-fields">
    ...
    <?php if( count($data['pax_info']->compact) ): for( $i = 1 ; $i <= count($data['pax_info']->compact) ; $i++ ):?>
        ...
        <!-- first section -->
            ...
            <div class="col-lg-8 per-cab-fare"><p>Per cab:</p><i class="fa fa-inr"></i>&nbsp;<span><?php echo $total_fare;?></span></div>
        </div>
    ...
    <?php if( count($data['pax_info']->sedan) ): for( $i = 1 ; $i <= count($data['pax_info']->sedan) ; $i++ ):?>
        <div class="row center-align-text fl_row">
            ...
            <div class="col-lg-8 per-cab-fare"><p>Per cab:</p><i class="fa fa-inr"></i>&nbsp;<span><?php if($data['extra_info']->car_model[0] == 'Indigo'){echo $data['extra_info']->total_fare[0];}else{echo $data['extra_info']->total_fare[1];}?></span></div>
        </div>
        <div class="row center-align-text">
            <!-- layover -->
            <div class="col-lg-24 remove-padding grey-line"></div>
    ...
    <?php if( count($data['pax_info']->suv) ): for( $i = 1 ; $i <= count($data['pax_info']->suv) ; $i++ ):?>
        <div class="row center-align-text fl_row">
            ...
            <div class="col-lg-8 per-cab-fare"><p>Per cab:</p><i class="fa fa-inr"></i>&nbsp;<span><?php if($data['extra_info']->car_model[1] != 'Indigo'){echo $data['extra_info']->total_fare[1];}else{echo $data['extra_info']->total_fare[2];}?></span></div>
        </div>
        <?php if( $i != $suvs ): ?>
            <div class="row center-align-text">
                <!-- layover -->
    ...
    <div id="popoverHiddenTitle" style="display: none;">
        <div class="row">
            <div class="col-lg-8 pull-left center-align-text">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-24 col-sm-24 busPopPaddingTop ellipse">
                        <?php if($_SESSION['travel_id'] == 2) echo $data['destination']; else echo $data['destination'].'0kms/'.$data['destination'].'hrs';?>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row">
                    <div class="busPopPaddingTop"><?php if(isset($_SESSION['duration_selected_cabs'])) {echo $_SESSION['duration_selected_cabs'];}  ?></div>
                </div>
            </div>
            <div class="col-lg-10 pull-right">
                ...
                <div class="col-lg-14 pop-title-text"><?php echo date('d M Y', strtotime($data['to_date']));?></div>
            </div>
        </div>
    </div> 
</div>
                ...
                <div class="row fl_overwiew">
                    <div class="col-lg-5 fl_septr1">
                        ...
                        <div class="col-lg-14 fl_info">
                            ...
                            <div class="row">
                                <div class="col-lg-23 col-lg-offset-1 cabTotFare1 center-align-text"><i class="fa fa-inr"></i>&nbsp;<span><?php echo $total_fare;?></span></div>
                            </div>
                        </div>
        ...
        <div class="row" style="margin-top: 35px;">
            <div class="col-xs-24 col-md-offset-2 col-lg-offset-2 col-sm-14 col-md-14 col-lg-14">
                <form action="<?php echo site_url('cabs/payment_gateway')?>" method="post" id="cab_traveller_details_form">
                    ...
                    <input name='discountCode' id='discountCode' style="display:none;"/>
                    <input name='discountValue' id='discountValue' style="display:none;"/>
                    ...
                    <div class="col-xs-24 col-sm-24 col-md-24 bookingSelectionDetails">
                        <table class="table table-condensed table-custom" >
                            <tbody>
                                ...
                                <tr>
                                    <td>Base fare</td>
                                    <td class="right-text tf-cng base-fare"><i class="fa fa-inr"></i>&nbsp;<span><?php echo $data['total_fare'];?></span></td>
                                </tr>
                                <tr>
                                    <td>Discount</td>
                                ...
                                <tr>
                                    ...
                                    <td class="right-text tf-cng convenience_charge"><i class="fa fa-inr"></i>&nbsp;<span><?php echo $convenience_charge;?><span></td>
                                </tr>
                                <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                                <tr>
                                    <td>Total Fare <span class="glyphicon glyphicon-question-sign totalNote"></span> </td>
                                    <td class="right-text tf-cng"><div class="row totFare"><strike><i class="fa fa-inr"></i>&nbsp;<span><?php echo $total_fare;?></span></strike></div><div class="row finalFare"><i class="fa fa-inr"></i>&nbsp;<span><?php echo $total_fare;?></span></div></td>
                                </tr>
...
// validation
            ...
            fields: {
                ...
                'pickup_addr': {
                    validators: {
						...
						stringLength: {
							max: 150,
							message: 'Address should be within 100 characters.'
						}	
                    }
                },
                'drop_addr': {
                ...
                'timeHours': {
                    validators: {
                        notEmpty: {
                            message: 'The time in hours is required'
                        }
                    }
                },
                'timeMins': {
                    validators: {
                        notEmpty: {
                            message: 'The time in minutes is required'
                        }
                    }
                },
            }
    ...
    $('#cab_traveller_details_form_submit').on('click', function(e){
        ...
        var timeHours = $(document).find('select.timeHours');
        var timeMins = $(document).find('select.timeMins');

        $.each( timeHours, function(i, val){
            if( val.id === 'not_selected' ){
                not_selected_flag = 1;
            }
        });

        $.each( timeMins, function(i, val){
            if( val.id === 'not_selected' ){
                not_selected_flag = 1;
            }
        });
