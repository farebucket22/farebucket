<?php 
    ...
    if(isset($_GET['source'])){
        $get_explode = explode(',', $_GET['source']);
        $get_src = $_SESSION['cab_state_id'];
        $_GET['out_cab_src'] = $get_src .'-'. $get_explode[0];
        $get_explode = explode(',', $_GET['destination']);
        $get_dest = $_SESSION['cab_city_id'];
        $_GET['local_cab_dest'] = $get_dest .'-'. $get_explode[0];
    }
?> 
...
<?php else:?>
    <form action="<?php echo site_url('cabs/travellers_details')?>" method="post" id="cabs_form" style="display:none">
        <input type="text" name="source" value="<?php if(isset($_GET['local_cab_src'])){echo $_GET['local_cab_src'];}else if(isset($_GET['out_cab_src'])){echo $_GET['out_cab_src'];}?>" />
        ...
        <input type="text" name="to_date" value="<?php if(isset($_GET['to_date'])){echo $_GET['to_date'];} else if(isset($_GET['journey_date'])){ echo $_GET['journey_date'];}?>" />
        <input type="text" name="cab_type" value="<?php echo $_GET['flight_type'];?>" />
        <input type="text" name="compacts" value="" id="Compact" />
        <input type="text" name="sedans" value="" id="Sedan" />
        <input type="text" name="suvs" value="" id="suv" />
...
<div class="hidden-fields">
    <div id = "cabAddHelpContent" style="display:none">
        <div class="row col-lg-24">
            <p>Please use + and - to add/remove cabs. You can select multiple cabs</p>
        </div>
    </div>
    <div id="popoverHiddenContent" style="display: none">
        ...
        <div class="row center-align-text fl_row" id="compactDetails">
            ...
            <div class="col-lg-4 per-cab-fare" id="perCabFare"><i class="fa fa-inr"></i>&nbsp;<span>0</span></div>
            <div class="col-lg-8 per-cab-fare" id="totalFare"><i class="fa fa-inr"></i>&nbsp;<span>0</span></div>
        </div>
        ...
        <div id="popoverFareHiddenContent-<?php echo $data['CarTypeID'][$i-1];?>" style="display: none;">
            <div class="center-align-text smallerFonts">
                ...
                <div class="fareCalc">
                    ...
                    <div>+ Driver Charges : <i class="fa fa-inr"></i>&nbsp; <?php echo $data['driver_bata'][$i-1];?>.00 Per Day</div>
                    <div><b>Total Fare: <i class="fa fa-inr"></i>&nbsp; <?php echo $data['total_fare'][$i-1];?></b></div>
                    <hr>
                    ...
                    <div>+ Night Charges : <i class="fa fa-inr"></i>&nbsp;200 between 2300 Hrs to 0500 Hrs</div>
                    <hr>
                </div>
                      ...
                      <?php endfor;?>
                              ...
                              <div class="row">
                                ...
                                <?php endif;?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-23 col-lg-offset-1 totFare2 cab-fare center-align-text" style="display:none;"><i class="fa fa-inr"></i>&nbsp; <span></span>
                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 pull-right">
                                            <div class="row fl_btn1">
                                                <div class="link-btn-ed hide">
                                                    <a class='btn-ed'>EDIT</a>
                                                </div>
                                                <div class="link-btn-de">
                                                    <a class='btn-de' id='popover-toggle' data-toggle="popover" data-placement="bottom">DETAILS</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <?php else:?>
                            ...
                            <div class="accord-content container-fluid">
                              ...
                              <div class="row">
                                <?php if( isset($_GET['journey_date']) ):?>
                                  <div class="col-lg-24 TravelDate center-align-text"><?php echo date('D, jS M Y', strtotime($_GET['journey_date']));?>, <?php if(isset($_SESSION['duration_selected_cabs'])) { echo $_SESSION['duration_selected_cabs']; } ?></div>
                                <?php else:?>
                                  <div class="col-lg-24 TravelDate center-align-text"><?php echo date('D, jS M Y', strtotime($_GET['to_date']));?> , <?php if(isset($_SESSION['duration_selected_cabs'])) {echo $_SESSION['duration_selected_cabs']; } ?></div>
                                <?php endif;?>
                              </div>
                                            <div class="row">
                                                <div class="TotFare1" id="cabTotalFare" style="display:none;"></div>
                                                <div class="col-lg-23 col-lg-offset-1 totFare2 cab-fare center-align-text" style="display:none;"><i class="fa fa-inr"></i>&nbsp; <span></span></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 pull-right">
                                            <div class="row fl_btn1">
                                                ...
                                                <div class="link-btn-de">
                                                    <a href="#" class='btn-de' id='popover-toggle' data-toggle="popover" data-placement="bottom">DETAILS</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row cabMarginBottom">
                <div  class="col-sm-offset-cust-19 col-xs-7">
                    <div class="flightOptionContainer row">
                        ...
                        <div class="col-xs-16 flightOptionDetails">
                            ...
                            <div class="row flightOptionDetailsLine2"><i class="fa fa-inr"></i>&nbsp; 3999.00</div>
                        </div>
                ...
                <div  class="col-xs-7 col-sm-offset-cust-3">
                    <div class="busOptionContainer row">
                        ...
                        <div class="col-xs-18 noBusesLabel">No Buses available</div>
      ...
      <center><small class="successMessage"></small></center>
        ...
        <div class="row">
            ...
            <?php if($data['CarTypeID'][0] != 1):?>
                <div class="noCabOverlay">
                    <span class="msgText">Not Available</span>
                </div>
            <?php endif;?>
                <div class="row">
                    <div class="cab-container center-align-text">
                        ...
                        <h3>Tata Indica</h3>
                        <p>4 Pax + Driver</p>
                        <p class="per_cab_fare"><i class="fa fa-inr"></i>&nbsp; <span><?php if($data['CarTypeID'][$i] == 1){echo $data['total_fare'][$i];}else{echo '-';}?></span>/cab</p>
                        <p>Air-Conditioned</p>
                        <div class="row add-section">
                            <div class="col-lg-16">
                                <p class="car_count" id="car_field0"><?php echo 'Compact (0 Selected)';?></p>
                            </div>
                            <div class="col-lg-8 car_count">
                                <?php 
                                    if($data['CarTypeID'][0] == 1){
                                        ...
                                        echo '<button type="button" id="0" class="btn-add-cab btn-custom-calc plusBtn"><span class="glyphicon glyphicon-plus"></span></button>';
                                        echo '<span class="glyphicon glyphicon-question-sign pull-right addHelpButton cabAddHelp" tabindex="0" data-trigger="focus" data-toggle="popover" data-placement="top"></span>';
                                    }else{
                                        $j = 0;
                                        ...
                                        echo '<button disabled="disabled" type="button" id="0" class="btn-add-cab btn-custom-calc plusBtn"><span class="glyphicon glyphicon-plus"></span></button>';
                                        echo '<span class="glyphicon glyphicon-question-sign pull-right addHelpButton cabAddHelp" tabindex="0" data-trigger="focus" data-toggle="popover" data-placement="top"></span>';
                                    }
                                ;?>
                            </div>
                        ...
                        <div class="row add-section remove-padding">
                            <div class="col-lg-24">
                                <div class="tot_fare per_cab_fare"><i class="fa fa-inr"></i>&nbsp;<span><?php if($data['CarTypeID'][$i] == 1){echo $data['total_fare'][$i];$i++;}else{echo '-';}?></span> <span class="glyphicon glyphicon-question-sign fareBreakdown farePopover-1" tabindex="0" data-trigger="focus" data-toggle="popover" data-placement="top"></span> </div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="row">
                    <div class="cab-container center-align-text">
                        ...
                        <h3>Indigo</h3>
                        <p>4 Pax + Driver</p>
                        <p class="per_cab_fare"><i class="fa fa-inr"></i>&nbsp;<span><?php if($data['CarTypeID'][$i] == 6){echo $data['total_fare'][$i];}else{echo '-';}?></span>/cab</p>
                        <p>Air-Conditioned</p>
                        <div class="row add-section">
                            <div class="col-lg-16">
                            ...
                            <div class="col-lg-8 car_count">
                                ...
                                if($data['CarTypeID'][$j] == 6){
                                    $j++;
                                    echo '<button type="button" id="1" class="btn-add-cab btn-custom-calc plusBtn"><span class="glyphicon glyphicon-plus"></span></button>';
                                    ...
                                    echo '<span class="glyphicon glyphicon-question-sign pull-right addHelpButton" tabindex="0" data-trigger="focus" data-toggle="popover" data-placement="top"></span>';
                                }
                                ;?>
                            </div>
                        </div>
                        <div class="row add-section remove-padding">
                            <div class="col-lg-24">
                                <div class="tot_fare per_cab_fare"><i class="fa fa-inr"></i>&nbsp;<span><?php if($data['CarTypeID'][$i] == 6){echo $data['total_fare'][$i];$i++;}else{echo '-';}?></span> <span class="glyphicon glyphicon-question-sign fareBreakdown farePopover-6" tabindex="0" data-trigger="focus" data-toggle="popover" data-placement="top"></span> </div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="row">
                    <div class="cab-container center-align-text">
                        ...
                        <h3>Toyota Innova</h3>
                        <p>6 Pax + Driver</p>
                        <p class="per_cab_fare"><i class="fa fa-inr"></i>&nbsp;<span><?php if(isset($data['CarTypeID'][$i])){if($data['CarTypeID'][$i] == 21){echo $data['total_fare'][$i];}else{echo '-';}}?></span>/cab</p>
                        <p>Air-Conditioned</p>
                        <div class="row add-section">
                            <div class="col-lg-16">
                            ...
                            <div class="col-lg-8 car_count">
                                ...
                                if($data['CarTypeID'][$j] == 21){
                                    echo '<button type="button" id="2" class="btn-add-cab btn-custom-calc plusBtn"><span class="glyphicon glyphicon-plus"></span></button>';
                        ...
                        <div class="row add-section remove-padding">
                            <div class="col-lg-24">
                                <div class="tot_fare per_cab_fare"><i class="fa fa-inr"></i>&nbsp;<span><?php if(isset($data['CarTypeID'][$i])){if($data['CarTypeID'][$i] == 21){echo $data['total_fare'][$i];}else{echo '-';}}?></span> <span class="glyphicon glyphicon-question-sign fareBreakdown farePopover-21" tabindex="0" data-trigger="focus" data-toggle="popover" data-placement="top"></span> </div>
                            </div>
                        </div>
                    </div>
                </div>
...
var noCabParentWidth = $('.noCabOverlay').parent().outerWidth() - 80;
var noCabParentHeight = $('.noCabOverlay').parent().outerHeight();
$('.noCabOverlay').css({
    'width': noCabParentWidth,
    'right': '40px',
    'height': noCabParentHeight
});
    
var toPushTextRight = (noCabParentWidth)/2;
var noCabMsgTextWidth = $('.noCabOverlay .msgText').width();
var noCabMsgTextHeight = $('.noCabOverlay .msgText').height();

$('.noCabOverlay .msgText').css({
    'left': toPushTextRight + 5,
    'margin-left': '-'+(noCabMsgTextWidth/2)+'px',
});
...
var dest = "<?php if(isset($_SESSION['travel_id']) && $_SESSION['travel_id'] == 2) echo $data['destination']; else echo $data['destination'].'0kms/'.$data['destination'].' hrs';?>";
    ...
    $('.btn-checkout').on('click', function(){
      ...
      $('.selectMessageBlock .errorMessage').html('Please choose a cab using the "+" button.').fadeIn(200);
        setTimeout(function(){
  ...
  <?php endif;?>
    $.ajax({
        url: "<?php echo site_url('api/flights/chk_lowest_fare');?>",
        type: "POST",
    ...
    .done(function (flData){
        ...
        if(result !== "false")
        {
            ...
            if( typeof result.minFare == 'undefined' ){
                $('.flightOptionDetailsLine2').html('<i class="fa fa-inr"></i>&nbsp;' +result.fare_min);
            }else{
                $('.flightOptionDetailsLine2').html('<i class="fa fa-inr"></i>&nbsp;' +result.minFare);
            }
