<?php
	...
	if(isset($_SESSION['currentUrlFlight'])){
		$currentUrlFlight = $_SESSION['currentUrlFlight'];
	}
	...
	$_SESSION['currentUrlFlight'] = $currentUrlFlight;
...
?>
<head>
    <title>Farebucket: Cheap Cabs In Bangalore | Cheap Cabs In Chennai | Cheap Domestic Air Tickets</title>

<meta name="Subject" content="Cheap Cabs In Bangalore" />

<meta name="description" content="Farebucket  is an online travel booking portal founded in 2013 by three technocrats to make booking tickets as interactive as possible in chennai, bangalore. Cheap Cabs In Bangalore, Cheap Cabs In Chennai, Cheap Domestic Air Tickets" />

<meta name="keywords" content="Cheap Cabs In Bangalore, Cheap Cabs In Chennai, Cheap Domestic Air Tickets, Book Cheap Air Tickets India, Cheap Flight Tickets Booking, Cheap Air Tickets India, Lowest Airfare In India, Cheap Cab Services In Chennai, Cheap Cab Rates In Chennai, Cheap Call Taxi In Chennai, Cheap Call Taxi Tariff Chennai, Cheap Hotel Packages, Book Cheap Hotels In Chennai " />
                ...
                <form action="<?php echo site_url('flights/oneway');?>" method="get" id="form-submit-1" enctype="multipart/form-data">
                    <div class="form-padding row">
                        <div class="form-group">
                            <div class="col-lg-6 control-label">
                                <div class="deleteicon">
                                    <input type="text" onClick="this.select();" tabindex='1' class="form-control searchBox" data-num="1" autocomplete="off" name="from" placeholder="Source">
                                    <input type="hidden" name="utf_from" class="utf" value="0" />
                                    <a href="javascript:void(0);" tabindex='-1' class="glyphicon"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 control-label">
                                <div class="deleteicon">
                                    <input type="text" onClick="this.select();" tabindex='2' class="form-control searchBox" data-num="2" autocomplete="off" name="to" placeholder="Destination">
                ...
                <form action="<?php echo site_url('api/flights/return_parameters');?>" method="get" id="form-submit-2" enctype="multipart/form-data">
                    <div class="form-padding row">
                        <div class="form-group">
                            <div class="col-lg-6 control-label">
                                <div class="deleteicon">
                                    <input type="text" onClick="this.select();" tabindex='3' class="form-control searchBox" data-num="3" autocomplete="off" name="from" placeholder="Source">
                                    <input type="hidden" name="utf_from" class="utf" value="0" />
                                    <a href="javascript:void(0);" tabindex='-1' class="glyphicon"></a>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 control-label">
                                <div class="deleteicon">
                                    <input type="text" onClick="this.select();" tabindex='4' class="form-control searchBox" data-num="4" autocomplete="off" name="to" placeholder="Destination">
                                    <input type="hidden" name="utf_to" class="utf" value="0" />
                                    <a href="javascript:void(0);" tabindex='-1' class="glyphicon"></a>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-padding control-label">
                                <div class="deleteicon">
                                    ...
                                    <a href="javascript:void(0);" tab-index='-1' class="glyphicon"></a>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="clone">
                            <div class="row form-padding" id="flight_form_2">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6 col-padding control-label">
                                        <div class="deleteicon">
                                            <input type="text" onClick="this.select();" class="form-control searchBox" data-num="9" autocomplete="off" name="city_from_three" placeholder="Source">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6 col-padding control-label">
                                        <div class="deleteicon">
                                            <input type="text" onClick="this.select();" class="form-control searchBox" data-num="10" autocomplete="off" name="city_to_three" placeholder="Destination">
                        ...
                        <div class="clone">
                            <div class="row form-padding" id="flight_form_3">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6 col-padding control-label">
                                        <div class="deleteicon">
                                            <input type="text" onClick="this.select();" class="form-control searchBox" data-num="11" autocomplete="off" name="city_from_four" placeholder="Source">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6 col-padding control-label">
                                        <div class="deleteicon">
                                            <input type="text" onClick="this.select();" class="form-control searchBox" data-num="12" autocomplete="off" name="city_to_four" placeholder="Destination">
...
<script type="text/javascript" >
    ...
    $(document).ready(function(){
        ...
        //reset the forms
        $('#form-submit-1').get(0).reset();
        $('#form-submit-2').get(0).reset();
        $('#form-submit-3').get(0).reset();
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url('scripts/airport-codes-test.xml');?>", // change to full path of file on server
            dataType: "xml",
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url('scripts/Airline.xml');?>", // change to full path of file on server
            dataType: "xml",
            success: function(xml){
                temp1 = xmlToJson(xml);
...
// clear the input field when remove is clicked.
        $('a.glyphicon').on('click', function(e){
            var $this = $(this);
            var input = $this.siblings('input');
            input.val('');
            $this.removeClass('glyphicon-remove');
        });
// clear the input field when remove is clicked end.
...
$.vegas('slideshow', {
    ...
    $(document).on( 'click', '#form-submit-button', function( e ){
        e.preventDefault();
		var active_tab = $(document).find('.active');
        var inputs = [];
        var j = 0;
        if( active_tab[1].id == "oneWay" ){
            for(var i = 0; i<2 ; i++){
                inputs[i] = all_ios[i];
            }
        }
        if( active_tab[2].id == "roundTrip" ){
            for(var i = 2; i<4 ; i++){
                inputs[j] = all_ios[i];
                j++;
            }
