...
<?php
    ...
    $_SESSION['flight_db_fare_params']['flight_published_price'] = $fare_obj->PublishedPrice + $fare_obj1->PublishedPrice;
    ...
    <?php if( is_array($data['inbound_booking_details']->rest->Segment->WSSegment) ): 
        ...
        <?php else:?>
            <div class="row center-align-text fl_row">
                ...
                <div class="col-lg-6 left-text">
                    <div class="row date-text center-align-text">Flight Number</div>
                    <div class="row date-text center-align-text"><?php echo $data['inbound_booking_details']->rest->Segment->WSSegment->OperatingCarrier;?> - <?php echo $data['inbound_booking_details']->rest->Segment->WSSegment->FlightNumber;?></div>
                </div>
                <div class="col-lg-12 travel-text-margin remove-padding">
                    <div class="row travel-text">
                ...
                'first_name_lead': {
                    validators: {
						...
						stringLength: {
							min: 2,
							max: 50,
							message: 'First Name must be betwen 2 and 50 characters'
						}
                    }
                },
                'last_name_lead': {
