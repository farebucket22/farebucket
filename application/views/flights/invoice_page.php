		...
		<div class="container clear-top">
			...
			<div class="row">
				...
				<div class="row intin-container">
					...
					<h3 class="nbsps">&nbsp;|&nbsp;</h3>
					<h3 class="break"><br /></h3>
					<h3 class="subact_name"><?php echo date("l, d-M-y", strtotime($con_dep[0]));?></h3>
					<h3 class="subact_name">, <?php echo date("H:i:s", strtotime($con_dep[0]));?>&nbsp; hrs</h3>
				</div>
			</div>
			<div class="row ticket_details">
				<div class="col-lg-4 col-xs-24">
					<span class="tckt-dep col-lg-24 col-xs-12">Airline</span>
					<h4 class="col-lg-24 col-xs-12"><?php echo $data[0]->ConnectingAirlineName;?></h4>
				</div>
				<div class="col-lg-6 col-xs-24">
					<h5 class="col-xs-24"><?php if($stop_count) {echo $stop_count.'Stop(s)';}else{echo 'Non-Stop';};?></h5>
					<span class="tckt-dep col-lg-24 col-xs-24">Flight Info</span>
					<?php
					...
					?>
					<h5 class="col-lg-24 col-xs-12"><?php echo $refund;?></h5>
					<h5 class="col-lg-24 col-xs-12">Duration: <?php echo $data1[0]->flight_duration;?></h5>
				</div>
				<div class="col-lg-5 col-xs-24">
					<span class="tckt-dep col-xs-24">Departure</span>
					<h4 class="col-lg-24 col-xs-12"><?php if($stop_count){echo $origin_city[0];}else{echo $data[0]->OriginCityName;} if($stop_count){echo '('.$origin_code[0].')';}else{echo '('.$data[0]->OriginCityCode.')';}?></h4>
					<h6 class="col-lg-24 col-xs-12"><?php if($stop_count){echo date("l, d-M-y", strtotime($con_dep[0]));}else{echo date("l, d-M-y", strtotime($data[0]->ConnectingDepTime));}?>, <?php echo date ("H:i",strtotime($con_dep[0]));?>&nbsp hrs</h6>
				</div>
				<div class="col-lg-4 col-xs-24">
					<span class="tckt-dep col-lg-24 col-xs-12">Stops</span>
					<h5 class="col-lg-24 col-xs-12"><?php if($stop_count) {echo $stop_count.'Stop(s)';}else{echo 'Non-Stop';};?></h5>
				</div>
				<div class="col-lg-5 col-xs-24">
					<span class="tckt-dep col-xs-24">Arrival</span>
					<h4 class="col-lg-24 col-xs-12"><?php if($stop_count){echo $origin_city[1];}else{echo $data[0]->DestinationCityName;} if($stop_count){echo '('.$origin_code[1].')';}else{echo '('.$data[0]->DestinationCityCode.')';}?></h4>
					<h6 class="col-lg-24 col-xs-12"><?php if($stop_count){echo date("l, d-M-y", strtotime($con_arr[0]));}else{echo date("l, d-M-y", strtotime($data[0]->ConnectingArrTime));}?>, <?php echo date ("H:i",strtotime($con_arr[0]));?>&nbsp hrs</h6>
				</div>
			</div>
			<?php for($i = 1 ; $i <= $stop_count; $i++){?>
			<div class="row">
				<div class="col-lg-offset-10  col-lg-5 col-xs-24">
				...
				<div class="col-lg-offset-4 col-lg-5 col-xs-24">
			...
			<div class="row passenger-list">
				...
				<div class="col-lg-8 col-xs-6 passenger-headers">
				...
				<div class="col-lg-4 col-xs-6 passenger-headers">
				...
				<div class="col-lg-6 col-xs-6 passenger-headers">
					<h6>Airline PNR</h6>
					<p><?php echo $data[0]->PNR;?></p>
				</div>
				<div class="col-lg-6 col-xs-6 passenger-headers">
					<h6>E-Ticket Number</h6>
					<p><?php echo $data[0]->TicketNumber;?></p>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-24 passenger-headers form-padding baggageInfo">
					...
					<ul>
						<li>No refund on non-refundable flight bookings.</li>
						<li>The refund amount for refundable flights will be known only at the time of cancellation.</li>
					</ul>
				</div>
			</div>
