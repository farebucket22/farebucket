	...
	<div class="wrap">
		<div class="container clear-top">
			...
			<div class="row passenger-list">
				<div class="col-lg-2 col-xs-2 passenger-headers">
					<h6>Rooms</h6>
				...
				<div class="col-lg-3 col-xs-6 passenger-headers">
			...
			<div class="cancel-policy">
				<span class="h4">Cancellation Policy:</span>
					<div class="row">
					<?php $policyStr = explode('|',$policy);
						$count = count($policyStr);
						for ($i=0;$i<$count-1;$i++) {?>
						<ul>
							<li><?php echo $policyStr[$i];?></li>
						</ul>
					<?php } ?>
				</div>
			</div>	
			<div class="checkTime">
				<span class="h4">Other Information</span>
					<div class="row">
					<?php $checkTime = explode('|',$checkTime);
						$count = count($checkTime);
						for ($i=0;$i<$count-1;$i++) {?>
						<ul>
							<li><?php echo $checkTime[$i];?></li>
						</ul>
					<?php } ?>
				</div>
			</div>
...
<script>
	$(document).ready(function(){
        ...
        var checkTime = <?php echo $checkTime; ?>;
        var information = '<ul>';
        $.each(checkTime, function(i,val){
            information += '<li>'+val+'</li>';
        });
        information += '</ul>';
        $('#checkInOutTime').html(' <div class="row otherInfo"><div class="row"><span class="h4">Other Information</span></div><div class="col-lg-22 info">'+information+'</div>');
