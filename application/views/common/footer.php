...
<!-- /container --> 
        <div class="container-fluid">      
            <div class="row footer">
                <ul class="col-xs-24 col-sm-19 col-lg-16 footerNav">
                    <li class="col-xs-24 col-sm-2 col-sm-offset-1 col-lg-2<?php if( $url[count($url)-1] == 'about')echo 'active_tab';?>"><a href="<?php echo site_url('common/about');?>">About</a></li>
                    <li class="col-xs-24 col-sm-2 col-lg-2<?php if( $url[count($url)-1] == 'contact')echo 'active_tab';?>"><a href="<?php echo site_url('common/contact');?>">Contact</a></li>
                    <li class="col-xs-24 col-sm-2 col-lg-2<?php if( $url[count($url)-1] == 'privacy')echo 'active_tab';?>"><a href="<?php echo site_url('common/privacy');?>">Privacy</a></li>
                    <li class="col-xs-24 col-sm-2 col-lg-2<?php if( $url[count($url)-1] == 'terms')echo 'active_tab';?>"><a href="<?php echo site_url('common/terms');?>">Terms</a></li>
                    <li class="col-xs-24 col-sm-2 col-lg-2"><a href="#" data-toggle="modal" data-target="#app_modal">Mobile</a></li>
                </ul>
                <div class="imageContainer col-xs-24 col-lg-4">
