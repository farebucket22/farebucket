    ...
    class GetBookRequest{
        ...
        public function setBookRequest($data, $passengerData){
            ...
            if ($data['adult_count_field'] >= 1) {
                ...
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["LastName"] = $passengerData['lead_adult_last_name'];
            ...
            while ($i < $data['adult_count_field']) {
                $j = $i - 1;
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Title"] = $passengerData['adult_title_csv'][$j];
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["FirstName"] = $passengerData['adult_first_name_csv'][$j];
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["LastName"] = $passengerData['adult_last_name_csv'][$j];
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Type"] = "Adult";
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["DateOfBirth"] = date('c',strtotime('1990-1-1'));
				if ( isset($data['fare_breakdown']['WSPTCFare'][0]) && count($data['fare_breakdown']['WSPTCFare']) > 1) {                    $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Fare"]["BaseFare"] = $data['fare_breakdown']['WSPTCFare'][0]['BaseFare'] / $data['adult_count_field'];
                    $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Fare"]["Tax"] = $data['fare_breakdown']['WSPTCFare'][0]['Tax'] / $data['adult_count_field'];
                    $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Fare"]["AdditionalTxnFee"] = $data['fare_breakdown']['WSPTCFare'][0]['AdditionalTxnFee'] / $data['adult_count_field'];
                    $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Fare"]["FuelSurcharge"] = $data['fare_breakdown']['WSPTCFare'][0]['FuelSurcharge'] / $data['adult_count_field'];
                    $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Fare"]["AgentServiceCharge"] = $data['fare_breakdown']['WSPTCFare'][0]['AgentServiceCharge'] / $data['adult_count_field'];
                ...
                if (!empty($passengerData['pass_number_a'][0])) {
            ...
            /*....*/
            $j = 0;
            while ($j < $data['youth_count_field']) {
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Title"] = $passengerData['kid_title_csv'][$j];
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["FirstName"] = $passengerData['kid_first_name_csv'][$j];
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["LastName"] = $passengerData['kid_last_name_csv'][$j];
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Type"] = "Child";
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["DateOfBirth"] = date('c', strtotime($passengerData['kid_dob_csv'][$j]));
                ...
                if ($passengerData['kid_title_csv'][$j] == 'Mr' || $passengerData['kid_title_csv'][$j] == 'Master') {
                    $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Gender"] = "Male";
                }
                else {
                    $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Gender"] = "Female";
                ...
                if (!empty($passengerData['pass_number_k'][0])) {
            ...
            /*--*/
            $j = 0;
            while ($j < $data['kids_count_field']) {
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Title"] = $passengerData['infant_title_csv'][$j];
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["FirstName"] = $passengerData['infant_first_name_csv'][$j];
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["LastName"] = $passengerData['infant_last_name_csv'][$j];
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Type"] = "Infant";
                $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["DateOfBirth"] = date('c',strtotime($passengerData['infant_dob_csv'][$j]));
                ...
                if ($passengerData['infant_title_csv'][$j] == 'Mr' || $passengerData['infant_title_csv'][$j] == 'Master') {
                    $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Gender"] = "Male";
                }
                else {
                    $book["Book"]["bookRequest"]["Passenger"]["WSPassenger"][$i]["Gender"] = "Female";
                }
                if (!empty($passengerData['pass_number_i'][0])) {
