<?php
	class GetReturnTicketInfo{
		...
		public function setReturnTicketInfo($result,$data){
	        ...
	        $info['fbBooking_id'] = $_SESSION['fb_bookingId_flights'];
	        $i=0;
	        ...
	        if (is_array($result->GetBookingResult->Ticket->WSTicket)) {
	            ...
	            foreach($result->GetBookingResult->Ticket->WSTicket as $wst) {
	                ...
	                $info['BaggageInfo'][$t] = $wst->SegmentAdditionalInfo->WSSegAdditionalInfo->Baggage;
	                $t++;
	            }
	            ...
	            $info['BaggageInfo'] = implode(',', $info['BaggageInfo']);
	        }
	        else {
	            ...
	            $info['BaggageInfo'] = $result->GetBookingResult->Ticket->WSTicket->SegmentAdditionalInfo->WSSegAdditionalInfo->Baggage;
	        }
	        return $info;
