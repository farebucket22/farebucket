    ...
    class GetInboundBookRequest{
        ...
        public function setInboundBookRequest($data){
            ...
            if (!is_array($data['details']->inbound_booking_details->rest->FareRule->WSFareRule)) {
                ...
                if( isset($data['details']->inbound_booking_details->rest->FareRule->WSFareRule->FareRestriction) && !empty($data['details']->inbound_booking_details->rest->FareRule->WSFareRule->FareRestriction) ){
                ...
                for ($t = 0; $t < count($data['details']->inbound_booking_details->rest->FareRule->WSFareRule); $t++) {
                    ...
                    if( isset($data['details']->inbound_booking_details->rest->FareRule->WSFareRule[$t]->FareRestriction) && !empty($data['details']->inbound_booking_details->rest->FareRule->WSFareRule[$t]->FareRestriction) ){
