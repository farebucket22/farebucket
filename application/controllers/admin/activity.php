...
class activity extends MY_Controller{
    ...
    function add()
    {
        ...
        $this->form_validation->set_rules('activity_address', 'Activity Address', 'required');
        $this->form_validation->set_rules('activity_phone_num', 'Activity Phone Number', 'required');
        ...
        $this->form_validation->set_rules('activity_onwards_price', 'Price', 'required');
        $this->form_validation->set_rules('activity_location_lat', 'Latitude', 'required|numeric');
        $this->form_validation->set_rules('activity_location_long', 'Longitude', 'required|numeric');
