...
class User extends MY_Controller{
    ...
    public function get_bus_bookings(){
        ...
        foreach( $busBookingDetails as $bbd ){
            ...
            $var->dispDoj = date('d-m-Y', strtotime($var->doj));
    ...
    public function guest_details(){
        ...
        if( isset($_SESSION['invalidGuestErrorMessage']) )unset($_SESSION['invalidGuestErrorMessage']);
        ...
        switch( $moduleCode ){
            ...
            case 'AC':
                ...
                break;
            default: $_SESSION['invalidGuestErrorMessage'] = '<div class="select-error"><h6 style="text-align:center;">Invalid User id or Ticket id.</h6></div>';
                    redirect('api/flights/guest_ticket');
            break;
        }
    }
