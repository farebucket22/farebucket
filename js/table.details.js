function format (flightSegment, fareBreakdown, generalInfo, layover, segmentInfo, selectedRowId, fromStr, toStr, isInternational) {
                            ...
                            +'<div class="col-lg-16">'
                                +'<div class="row">'
                                    +'<div class="col-lg-6 std-lineheight left-text">'
                                        +'<span class="inline-h4">'+fromStr+'</span> <span class="glyphicon glyphicon-arrow-right"></span> <span class="inline-h4">'+toStr+'</span>'
                                    +'</div>'
                                ...
                                +'</div>'
                                +'<div class="row">'
                                    +'<div class="col-lg-6 left-text"><div>'+flightSegment[0].Airline.AirlineName+'</div><div class="text-small">'+flightSegment[0].OperatingCarrier+'-'+flightSegment[0].FlightNumber+'</div></div>'
                                    ...
                                    +'<div class="col-lg-4 center-align-text duration-bg-color"><div class="row"></div></div>'
            ...
            for ( var i = 1 ; i <= flightSegment.length ; i++ ) {
                if( layover.length > 1 ){
                    if( i === flightSegment.length ){
                        ...
                        '<div class="row">'
                            +'<div class="col-lg-6 left-text"><div>'+flightSegment[i-1].Airline.AirlineName+'</div><div class="text-small">'+flightSegment[i-1].OperatingCarrier+'-'+flightSegment[i-1].FlightNumber+'</div></div>'
                ...
                if( layover.length > 1 ){
                    if( i === flightSegment.length ){
                        ...
                        '<div class="row">'
                            +'<div class="col-lg-6 left-text"><div>'+flightSegment[i-1].Airline.AirlineName+'</div><div class="text-small">'+flightSegment[i-1].OperatingCarrier+'-'+flightSegment[i-1].FlightNumber+'</div></div>'
                            +'<div class="col-lg-7 right-text"><div class="row">'+segmentInfo[i-1].DepartureTime+' <span class="ctCode">'+flightSegment[i-1].Origin.CityCode+'</span></div><div class="row sd-details-line-height">'+segmentInfo[i-1].OriginAirportInfo+'</div><div class="row">'+segmentInfo[i-1].DepartureDate+'</div></div>'
                            +'<div class="col-lg-4 center-align-text duration-bg-color"><div class="row"><span class="glyphicon glyphicon-time"></span></div><div class="row">'+segmentInfo[i-1].SegmentDuration+'</div></div>'
                            +'<div class="col-lg-7 left-text"><div class="row"><span class="ctCode">'+flightSegment[i-1].Destination.CityCode+'</span> '+segmentInfo[i-1].ArrivalTime+'</div><div class="row sd-details-line-height">'+segmentInfo[i-1].DestinationAirportInfo+'</div><div class="row">'+segmentInfo[i-1].ArrivalDate+'</div></div>'
                        +'</div>'
                    }else{
                        flightDetailsHtmlString[i] = 
